...
<html class="no-js" lang="es">
    ...
    <body>
      <header>
        <div class="logo"></div>
          <h1>Diseño web y desarrollo Front-End</h1>
        <div class="languages">
          <ul>
        ...
        <p class="call-to-scroll">Scoll para continuar ...</p>
      </header>
      <section class="container-fluid main">
        <div class="row">
          <div class="col-12 col-sm-6 offset-sm-1">
            <h2 class="title">About me</h2>
            <h3 class="content">Apasionado por las interfaces griMy passion for human interfaces led me to work as Flash(✝ 2016) developer for a decade, later I moved to open standards and webdesign. Most of my career passed in France for Agencies and start-ups. At the end of 2018 I started to offer my services as freelance.</h3>
          </div>
        </div>
      ...
      <section class="container-fluid">
        <div class="row references grad3">
          <div class="col-12 offset-sm-1">
            ...
            <h3 class="description">Una muestra de mis útlimos trabajos como desarrollador web</h3>
          </div>
      ...
      <form id="contactForm" class="container-fluid">
        <div class="row">
          <div class="col-12 offset-sm-1">
          <h2>Vamos a quedar</h2>
          <h3 id="contactTitle">Introduce tu e-mail en el formulario y te llegará un email con mis datos de contacto</h3>
          <p id="formResponse"></p>
        </div>
        </div>
        <fieldset>
          <div class="row">
            ...
            <div class="col-6">
              <input id="submitButton" type="submit" class="btn-large waves-effect" value="ENVIAR">
            </div>
          </div>
        </fieldset>
      </form>
      ...
      <script>
        ...
        XHR.addEventListener('load', function(event) {
          ...
          document.getElementById('formResponse').innerHTML = "Se ha enviado correctamente :-)";
          console.log("success");
        });
